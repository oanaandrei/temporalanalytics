        ...
        'http://127.0.0.1/docker.php',
        {
          ...
          files: [
            ...
            },
            {
              name: 'run.sh',
              content: '#!/bin/sh\n\nrm /data/output.txt\n' +
                `prism /data/prism.model /data/prism.props ${args} -exportresults /data/output.txt`,
              mode: 0777,
            },
          ],
          image: 'mseve/prism',
        ...
        response => {
          ...
          var results = lines.slice(1).map(line => {
            ...
            if (col.length > 1) {
              ...
              // the value returned by PRISM can be either a double or a Boolean
          ...
          resolve([results, response['output.txt'], response.stdout]);
        },
