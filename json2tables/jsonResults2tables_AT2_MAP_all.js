...
// this script generates latex and csv tables for VisitProbInit, VisitCountInit, StepCountInit, VisitProbBetween, StepCountBetween
...
if (process.argv.length<7) {
  console.log('Usage: node jsonResults2tables_AT2_MAP.js results_GPAM_K2.json K [latex|csv] [level1Dict|UseStop|level2Dict|level3Dict|threelevels|others]) [VPVCSCinit|VP1|SC1|VC1|PG3|VPbtw|SCbtw_1|SCbtw_2]');
  return;
}
...
fs.readFile(process.argv[2], function(err, data) {
  ...
  if (propType.indexOf("SCbtw") == 0 || propType.indexOf("VPbtw") == 0) {
  	if (process.argv.length<9) {
  		console.log('Usage: node jsonResults2tables_AT2.js results_Pattern_PAM_K2.json K csv threelevels [VPbtw|SCbtw_1|SCbtw_2] start end');
  		return;
  	}
  ...
  var fullDict = [
	{ id: "0", label: "UseStart", shortLabel: "UseStart" },
	{ id: "1", label: "TermsAndConditions", shortLabel: "TaC" },
  ...
  // Property MAP_VP1
  var table_headerMAP_VP1 = "\\begin{table}\n\\center\n\\caption{MAP property \VisitProbInit\ for GPAM(" + K + ") of AppTracker1}\\label{table:AT2_MAP_VP1_K" + K + "_" + dictType + "}\n{\\footnotesize\n\\begin{tabular}{|c|";

  // Property MAP_SC1_1
  var table_headerMAP_SC1_1 = "\\begin{table}\n\\center\n\\caption{MAP property \StepCountInit\ (counting any type of steps) for GPAM(" + K + ") of AppTracker1}\\label{table:AT2_MAP_SC1_1_K" + K + "_" + dictType + "}\n{\\footnotesize\n\\begin{tabular}{|c|";

  // Property MAP_SC1_2
  var table_headerMAP_SC1_2 = "\\begin{table}\n\\center\n\\caption{MAP property \StepCountInit\ (counting only steps in each pattern) for GPAM(" + K + ") of AppTracker1}\\label{table:AT2_MAP_SC1_2_K" + K + "_" + dictType + "}\n{\\footnotesize\n\\begin{tabular}{|c|";

  // Property MAP_VC1
  var table_headerMAP_VC1 = "\\begin{table}\n\\center\n\\caption{MAP property \VisitCountInit\ for GPAM(" + K + ") of AppTracker1}\\label{table:AT2_MAP_VC1_K" + K + "_" + dictType + "}\n{\\footnotesize\n\\begin{tabular}{|c|";

  // Property MAP_PG3_SteadyState
  var table_headerMAP_PG3 = "\\begin{table}\n\\center\n\\caption{MAP property SteadyState for GPAM(" + K + ") of AppTracker1}\\label{table:AT2_MAP_SteadyState_K" + K + "}\n{\\footnotesize\n\\begin{tabular}{|c|";

  var table_headerMAP_VPbtw = "\\begin{table}\n\\center\n\\caption{MAP property \VisitProbBetween\ for GPAM(" + K + ") and the time interval [" + timecut_start + ", " + timecut_end + "] of AppTracker1}\\label{table:AT2_MAP_VPbtw_K" + K + "_" + timecut_start + "_" + timecut_end + "}\n{\\footnotesize\n\\begin{tabular}{|c|";

  var table_headerMAP_SCbtw_1 = "\\begin{table}\n\\center\n\\caption{MAP property any \StepCountBetween\ for GPAM(" + K + ") and the time interval [" + timecut_start + ", " + timecut_end + "] of AppTracker1}\\label{table:AT2_MAP_SCbtw_1_K" + K + "_" + timecut_start + "_" + timecut_end + "}\n{\\footnotesize\n\\begin{tabular}{|c|";
  var table_headerMAP_SCbtw_2 = "\\begin{table}\n\\center\n\\caption{MAP property specific pattern \StepCountBetween\ for GPAM(" + K + ") and the time interval [" + timecut_start + ", " + timecut_end + "] of AppTracker1}\\label{table:AT2_MAP_SCbtw_2_K" + K + "_" + timecut_start + "_" + timecut_end + "}\n{\\footnotesize\n\\begin{tabular}{|c|";
