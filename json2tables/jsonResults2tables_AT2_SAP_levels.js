...
if (process.argv.length<7) {
  console.log('Usage: node jsonResults2tables_AT2.js results_Pattern_PAM_AT2_K2.json K [latex|csv] [level1Dict|UseStop|level2Dict|level3Dict] [VPVCSCinit|VP2|SC2]');
  // for VP2 and SC2 input also the time interval
  console.log('Usage: node jsonResults2tables_AT2.js results_Pattern_PAM_AT2_K2.json K latex threelevels [VP2|SC2] start end');
  return;
}
...
fs.readFile(process.argv[2], function(err, data) {
  ...
  // Property SAP_VP1_VC1_SC1
  var tableHeader_SAP_VPVCSCinit = "\\begin{table}\n\\center\n\\caption{Properties \\VPinitAP, \\VCinitAP, and \\SCinitAP\\ for PAM with $K = " + K + "$}\\label{table:AT2_SAP_VP1_VC1_SC1_K" + K + "_" + dictType + "}\n{\\footnotesize\n\\begin{tabular}{cc";
